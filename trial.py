...
def minimax(board):
    ...
    raise NotImplementedError
# move = minimax(board)
# print("the next ai move is " , minimax(board))
# board = result(board, move)
#print("board after next move" , result(board , (0,1)))
print("current state of the board is" , board)
print("the next player is ",player(board))
print("the possible actions are " , actions(board))
# # action = (1,2)

# # print("the winner is" , winner(board))
# # print("Has the game ended?\n" , terminal(board))
action = minimax(board)
print("next optimal move " ,action )
print(f"the action taken is{action} \n the board after the action is {result(board , action)}")
